...
/** Highlight stories: types + seed in `lib/highlights/`; runtime list from `HighlightsProvider`. */
export type { Highlight } from "./highlights/types";
export { defaultHighlights as highlights } from "./highlights/seedHighlights";
